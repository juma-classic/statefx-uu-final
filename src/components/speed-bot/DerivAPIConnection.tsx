...
export const DerivAPIConnection: React.FC<DerivAPIConnectionProps> = ({ onConnectionChange }) => {
    ...
    const connectToAPI = async () => {
        ...
        try {
            ...
            const ws = new WebSocket('wss://ws.derivws.com/websockets/v3?app_id=119554');
            ...
            ws.onopen = () => {
                ...
                console.log('✅ Connected to Deriv API with App ID: 119554');
            ...
            {!isConnected ? (
                <div className='connection-form'>
                    <div className='connection-info-box'>
                        ...
                        <p>
                            Connecting to Deriv API using App ID <strong>119554</strong> for real-time market data
                        ...
                        <div className='debug-info'>
                            ...
                            <div className='debug-item'>
                                <span>Endpoint:</span>
                                <span>wss://ws.derivws.com/websockets/v3?app_id=119554</span>
                            </div>
                            <div className='debug-item'>
                                <span>Status:</span>
                    ...
                    <div className='connection-actions'>
                        ...
                        <button
                            onClick={() => {
                                ...
                                const testWs = new WebSocket('wss://ws.derivws.com/websockets/v3?app_id=119554');
                                testWs.onopen = () => {
